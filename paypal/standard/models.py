...
from paypal.standard.conf import RECEIVER_EMAIL, POSTBACK_ENDPOINT, SANDBOX_POSTBACK_ENDPOINT, CHECK_EMAIL
    ...
    def verify(self, item_check_callable=None):
        ...
        if not self.flag:
            if self.is_transaction():
                ...
                if CHECK_EMAIL and self.receiver_email != RECEIVER_EMAIL:
